...
def plot_spg(spg,ax=None,wav=None,sample_rate=None,shift=0.01,frames=None,segwav=None,segspg=None,y=None,title=None,ylabel=None,**kwargs):   
...
def add_line_plot(ax,y,x=None,dx=1.,xlim='tight',ylim='tight',grid='False',title=None,xlabel=None,ylabel=None,**kwargs):
    """
...
def _old_plot_spg(spg=None,wav=None,seg=None,txt=None,figsize=(12,8),spg_scale=2,samplerate=16000,n_shift=160,tlim=None,ShowPlot=True):
    ...
    if WavPlot:
        ...
        ax.plot(wavtime,wav)
        wmax = 1.2 * max(abs(wav)+SIGEPS_FLOAT)
        ax.set_ylim(-wmax,wmax)
